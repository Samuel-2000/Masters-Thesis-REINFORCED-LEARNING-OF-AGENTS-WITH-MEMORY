    ...
    if args.command == "train":
        ...
        if args.play:
            ...
            env_config = {
                ...
                'energy_decay': 0.98,
                'energy_per_step': 0.1,
                'render_size': 512,  # Always render in play mode
            ...
            if not args.model:
                print("Error: --model argument is required for testing (unless using --play mode)")
                sys.exit(1)
